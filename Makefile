...
help:
	...
	@echo "! run_test1	=>  clean, compile & run the simulation for router_small_pkt_test in batch mode.			!" 
	@echo "! run_test2	=>  clean, compile & run the simulation for router_medium_pkt_test in batch mode.			!"
	@echo "! run_test3	=>  clean, compile & run the simulation for router_big_pkt_test in batch mode.			!" 
	@echo "! view_wave1 =>  To view the waveform of router_test	    						!" 
	@echo "! view_wave2 =>  To view the waveform of router_small_pkt_test	    						!" 
	@echo "! view_wave3 =>  To view the waveform of router_medium_pkt_test 	  						!" 
	@echo "! view_wave4 =>  To view the waveform of router_big_pkt_test    							!" 
...
run_test_VCS:	clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave1.fsdb -cm_dir ./mem_cov1 +ntb_random_seed_automatic +UVM_TESTNAME=router_test
	urg -dir mem_cov1.vdb -format both -report urgReport1
	
run_test1_VCS:	clean  sv_cmp_VCS		
	./simv -a vcs.log +fsdbfile+wave2.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov2 +ntb_random_seed_automatic -assert verbose=noattempt +UVM_TESTNAME=router_small_pkt_test 
	urg -dir mem_cov2.vdb -format both -report urgReport2
	
run_test2_VCS:	clean  sv_cmp_VCS	
	./simv -a vcs.log +fsdbfile+wave3.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov3 +ntb_random_seed_automatic -assert verbose=noattempt +UVM_TESTNAME=router_medium_pkt_test 
	urg -dir mem_cov3.vdb -format both -report urgReport3
	
run_test3_VCS:	clean  sv_cmp_VCS
	./simv -a vcs.log +fsdbfile+wave4.fsdb assert_enable_coverage=1 -cm_dir ./mem_cov4 +ntb_random_seed_automatic -assert verbose=noattempt +UVM_TESTNAME=router_big_pkt_test 
